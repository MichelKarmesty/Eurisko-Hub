...
`Admin123!`, or register as an employee (self-registration always creates an
Employee account — docs/api.md). Agent accounts are created by an Admin
(Users tab) or provisioned from the CLI. To provision demo accounts
